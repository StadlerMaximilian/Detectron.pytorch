...
__C.GAN.MODEL.DEBUG = False
__C.GAN.MODEL.POOL_ROI_FROM_IMAGE = False
__C.GAN.MODEL.BRANCH_EARLY = False
__C.GAN.MODEL.KAIMING_INIT = False

__C.GAN.TRAIN = AttrDict()
__C.GAN.TRAIN.PRETRAINED_WEIGHTS = ''
__C.GAN.TRAIN.PRE_TRAIN_GENERATOR = False
__C.GAN.TRAIN.IGNORE_BG_ADV_LOSS = False
__C.GAN.TRAIN.k = 1
__C.GAN.TRAIN.DATASETS_REAL = ()
__C.GAN.TRAIN.DATASETS_FAKE = ()
__C.GAN.TRAIN.PROPOSAL_FILES_REAL = ()
__C.GAN.TRAIN.PROPOSAL_FILES_FAKE = ()

# additional datasets to train generator on both datasets
__C.GAN.TRAIN.DATASETS_GEN = ()
__C.GAN.TRAIN.PROPOSAL_FILES_GEN = ()

# PRE-TRAINING
__C.GAN.TRAIN.IMS_PER_BATCH_PRE = 1
__C.GAN.TRAIN.BATCH_SIZE_PER_IM_PRE = 128
__C.GAN.TRAIN.FG_FRACTION_PRE = 0.25

# Discriminator
__C.GAN.TRAIN.IMS_PER_BATCH_D = 2
__C.GAN.TRAIN.BATCH_SIZE_PER_IM_D = 32
__C.GAN.TRAIN.FG_FRACTION_D = 1.0

# Generator
__C.GAN.TRAIN.IMS_PER_BATCH_G = 1
__C.GAN.TRAIN.BATCH_SIZE_PER_IM_G = 128
...
__C.GAN.TRAIN.ADV_LOSS_WEIGHT = 1e-1
...
__C.GAN.SOLVER.PRE_ITER = 5000
__C.GAN.SOLVER.PRE_WARM_UP_ITERS = 200
